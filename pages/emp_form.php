        ...
        <div class="card">
            ...
            <form method="post" action="emp_form.php<?= $editing ? '?emp_no=' . urlencode($emp_no) : '' ?>">
                ...
                <div class="form-group">
                    ...
                    <input id="emp_no" class="form-control" type="number" name="emp_no" value="<?= htmlspecialchars($emp_no) ?>" <?= $editing ? 'readonly' : '' ?>>
                </div>

                <div class="form-group">
                    <label for="first_name">Prénom :</label>
                    <input id="first_name" class="form-control" type="text" name="first_name" value="<?= htmlspecialchars($first_name) ?>">
                </div>

                <div class="form-group">
                    <label for="last_name">Nom :</label>
                    <input id="last_name" class="form-control" type="text" name="last_name" value="<?= htmlspecialchars($last_name) ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="birth_date" type="date" name="birth_date" value="<?= htmlspecialchars($birth_date) ?>">
                </div>
                <div class="form-group">
                    <label for="hire_date">Date d'embauche :</label>
                    <input class="form-control" id="hire_date" type="date" name="hire_date" value="<?= htmlspecialchars($hire_date) ?>">
                </div>
                <div class="form-group">
