...
<body>
    ...
    <div class="container">
        ...
        <?php } else { ?>
            ...
            <table>
                <tr>
                    <td><a href="change_dept.php?emp_no=<?= urlencode($employee['emp_no']) ?>"><button class="btn btn-secondary" type="button">Changer de département</button></a></td>
                    <td><a href="become_manager.php?emp_no=<?= urlencode($employee['emp_no']) ?>"><button class="btn btn-secondary" type="button">Devenir Manager</button></a></td>
                    <td><a href="emp_form.php?emp_no=<?= urlencode($employee['emp_no']) ?>"><button class="btn btn-secondary" type="button">Modifier l'employé</button></a></td>
                    <td> <a href="javascript:history.back()" class="btn">&larr; Retour</a></td>
                </tr>
            </table>
            <br>
            <table class="table">
